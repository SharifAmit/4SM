...
st.set_page_config(page_title="4SM", page_icon=im, layout="wide",
                   initial_sidebar_state="expanded")
st.markdown("<h1 style='text-align: center; color: black;'>4SM</h1>",
...
plot_col1, plot_col2, plot_col3, plot_col4, plot_col5 = plots_quant_csv_expander.columns(
  5)
...
if download_runs:
  ...
  create_download_zip(run_dir, dirname + '/tmp', f'4SM_run_{option}')
